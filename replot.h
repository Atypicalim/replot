...
#define _COLOR (RPixel){color.r, color.g, color.b, color.a}
#define _VECTOR(name) (RSoft_vector){name.x, name.y, 1}
#define _POINT(name) (RPoint){name.x, name.y}
#define _CENTER(name) (RPoint){name.x + name.w / 2, name.y + name.h / 2}
#define _RECT(name) (RSoft_rect){name.x, name.y, name.w, name.h}
#define _SIZE(name) (RSoft_area){name.w, name.h}
